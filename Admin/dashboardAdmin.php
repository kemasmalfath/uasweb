...
<body class="bg-gray-50">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 
  6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 
  2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0
   0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 
   2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" />
</svg>
      Dashboard
    </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5
   7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 
  ...
  <main class="ml-60 p-8">
    <div class="flex items-center gap-4 mb-8">
      ...
      <div>
        ...
        <span class="text-gray-500 text-sm">Dashboard Admin</span>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
      <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center border">
        ...
        <span class="text-3xl font-bold text-blue-800 mb-1">12</span>
      </div>
      <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center border">
        <span class="text-gray-400 text-xs mb-1">Belum Ditanggapi</span>
        <span class="text-3xl font-bold text-yellow-500 mb-1">3</span>
      </div>
      <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center border">
        <span class="text-gray-400 text-xs mb-1">Sudah Ditanggapi</span>
        <span class="text-3xl font-bold text-green-600 mb-1">9</span>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-8 mb-10 border">
      ...
      <div class="flex items-end gap-6 h-48">
        ...
        <div class="flex flex-col items-center w-20">
          <div class="w-8 bg-blue-600 rounded-t" style="height:90px"></div>
          <span class="text-xs mt-2 text-gray-600">Fasilitas Umum</span>
        </div>
        <div class="flex flex-col items-center w-20">
          <div class="w-8 bg-yellow-500 rounded-t" style="height:60px"></div>
          <span class="text-xs mt-2 text-gray-600">Akademik</span>
        </div>
        <div class="flex flex-col items-center w-20">
          <div class="w-8 bg-green-500 rounded-t" style="height:40px"></div>
          <span class="text-xs mt-2 text-gray-600">IT</span>
        </div>
        <div class="flex flex-col items-center w-20">
          <div class="w-8 bg-red-500 rounded-t" style="height:75px"></div>
          <span class="text-xs mt-2 text-gray-600">Kebersihan</span>
        </div>
        <div class="flex flex-col items-center w-20">
          <div class="w-8 bg-gray-400 rounded-t" style="height:20px"></div>
          <span class="text-xs mt-2 text-gray-600">Keamanan</span>
        </div>
        <div class="flex flex-col items-center w-20">
          <div class="w-8 bg-purple-500 rounded-t" style="height:30px"></div>
          <span class="text-xs mt-2 text-gray-600">Lain-lain</span>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-8 border">
      <h2 class="text-lg font-bold mb-4 text-gray-700">Pengajuan Terbaru</h2>
      <table class="w-full">
        <thead>
        ...
        <tbody>
          <tr class="border-t hover:bg-blue-50 transition">
            ...
            <td class="py-2 px-3"><span class="px-2 py-1 rounded-full text-xs bg-yellow-200 text-yellow-700 font-bold">Belum Ditanggapi</span></td>
